...
public class DDOClient {
    ...
    public void run(String managerID, Log LogObject, String[] args) {
        try {
            ORB orb = ORB.init(args, null);
            org.omg.CORBA.Object objRef =   orb.resolve_initial_references("NameService");
            NamingContextExt ncRef = NamingContextExtHelper.narrow(objRef);
            DCMS ddo = DCMSHelper.narrow(ncRef.resolve_str("DDO"));
            ...
            while (true) {
                ...
                switch (ch) {
                    case 1:
                        ...
                        ddo.createTRecord(fname, lname, add, ph, spc, "DDO", managerID);
                    ...
                    case 7:
                        ...
                        if (centServer.equals("MTL") || centServer.equals("LVL")) {
